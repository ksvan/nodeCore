...
The intent is to develop an property and casualty insurance core system in nodejs and nextjs. This is to be used conceptualla and for training. The solution should be feature complete, possible to use in insurance business process and have a customer facing frontend to login for service and sales purposes. Designwise it should be possible to scale it, allthough it will not be scaled up for this work. 
