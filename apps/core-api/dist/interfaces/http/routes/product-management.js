...
const service = new ProductManagementService(new PrismaProductManagementRepository(getPrismaClient()), new WsDomainEventPublisher());
...
export const registerProductManagementRoutes = async (app) => {
    ...
    app.delete("/v1/product-management/product-versions/:productVersionId/components/:componentVersionId", async (request, reply) => {
        const params = z
            .object({
    ...
    app.get("/v1/product-management/components/:componentId/versions/:version", async (request, reply) => {
        const params = z
            .object({
            ...
            .parse(request.params);
        try {
            const componentVersion = await service.getComponentVersionByCompositeKey(params.componentId, params.version);
    ...
    app.post("/v1/product-management/pricing-programs/:pricingProgramId/versions", async (request, reply) => {
