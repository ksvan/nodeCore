...
export const createExposureComponentDraft = (input) => {
...
export const updateExposureComponentDraftDefinition = (component, definition) => {
...
export const releaseExposureComponent = (component, releasedAt = new Date()) => {
